...
</script></head><body><!-- Step count 0--><div class="cucumber"><div id="cucumber-header"><div id="label"><h1>Cucumber Features</h1></div><div id="summary"><p id="totals"></p><p id="duration"></p><div id="expand-collapse"><p id="expander">Expand All</p><p id="collapser">Collapse All</p></div></div></div><div class="feature"><span class="tag">@api_test</span><h2><span class="val">Feature: Final Project for API Testing class</span></h2><p class="narrative"></p><div class='scenario'><span class="tag">@test</span><span class="scenario_file">features/feature_definitions/me_details_feature/me_details.feature:5</span><h3 id="scenario_1"><span class="keyword">Scenario:</span> <span class="val">Me Details</span></h3><ol><li id='' class='step passed'><div class="step_name"><span class="keyword">Given </span><span class="step val">I have set a connection to pivotal_tracker API service</span></div><div class="step_file"><span>features/step_definitions/me_details_steps/me_details_step.rb:6</span></div></li> <script type="text/javascript">moveProgressBar('100.0');</script><li id='' class='step passed'><div class="step_name"><span class="keyword">When </span><span class="step val">I send a <span class="param">GET</span> request to <span class="param">/me</span></span></div><div class="step_file"><span>features/step_definitions/me_details_steps/me_details_step.rb:11</span></div></li> <script type="text/javascript">moveProgressBar('100.0');</script><li id='' class='step passed'><div class="step_name"><span class="keyword">Then </span><span class="step val">I expect Status code <span class="param">200</span></span></div><div class="step_file"><span>features/step_definitions/me_details_steps/me_details_step.rb:21</span></div></li> <script type="text/javascript">moveProgressBar('100.0');</script></ol></div></div><script type="text/javascript">document.getElementById('duration').innerHTML = "Finished in <strong>0m7.780s seconds</strong>";</script><script type="text/javascript">document.getElementById('totals').innerHTML = "1 scenario (1 passed)<br />3 steps (3 passed)";</script></div></body></html>